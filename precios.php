...
<section class="register-banner">
  ...
  <div class="fuel-prices">
    <div class="fuel-panel diesel">
      <h2 class="gas-type">Diesel</h2>
      <div class="fuel-image">
        <!-- Coloca la ruta de tu imagen de diesel aquí -->
        <img src="imgs/diesel.jpg" alt="Diesel">
      </div>
      <p class="price">Precio: 1.30€/L</p>
    </div>
  
    <div class="fuel-panel gasoline">
      <h2 class="gas-type">Gasolina</h2>
      <div class="fuel-image">
        <!-- Coloca la ruta de tu imagen de gasolina aquí -->
        <img src="imgs/gasoil.jpg" alt="Gasolina">
      </div>
      <p class="price">Precio: 1.50€/L</p>
    </div>
  </div>
